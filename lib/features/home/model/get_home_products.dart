...
GetHomeProducts getHomeProductsFromJson(String str) => GetHomeProducts.fromJson(json.decode(str));

String getHomeProductsToJson(GetHomeProducts data) => json.encode(data.toJson());
...
class GetHomeProducts {
  ...
  factory GetHomeProducts.fromJson(Map<String, dynamic> json) => GetHomeProducts(
    status: json["status"],
