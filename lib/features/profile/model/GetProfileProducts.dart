...
GetProfileProducts getProfileProductsFromJson(String str) => GetProfileProducts.fromJson(json.decode(str));

String getProfileProductsToJson(GetProfileProducts data) => json.encode(data.toJson());

class GetProfileProducts {
  String status;
  List<Datum> data;
  ...
  factory GetProfileProducts.fromJson(Map<String, dynamic> json) => GetProfileProducts(
    status: json["status"],
...
final datumNameValues = EnumValues({
  "mest one": DatumName.MEST_ONE,
  "Mest one": DatumName.NAME_MEST_ONE,
